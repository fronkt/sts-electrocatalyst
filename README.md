...
| [`docs/22-multifidelity-dft-calibration.md`](docs/22-multifidelity-dft-calibration.md) | **DFT calibration protocol** — the UMA→QE→experiment funnel: PBE+U/SSSP spec, SQS targets, UMA↔DFT parity, consensus melt |
