#!/bin/bash
# Submit Low-state relaxation restart, 2026-09-22 held; caller verifies scheduler fields before release. No retry/override.
set -euo pipefail
export PROJECT=/anvil/projects/x-che260157
export STAGE=slab_relax_seeded
ROOT="$PROJECT/sts"
SPEC="$ROOT/results/lowtail_low_state_restart_2026-09-22/relax/launch_spec.json"
...
check_hash "$SPEC" 1aac528de88e568eee87543f551555fc98f980e42260106ad9b6cdd2ca7c1ec6
...
sbatch --parsable --hold --no-requeue -A che260157 -p shared -N 1 -n 128 \
    ...
    --export=ALL,PROJECT,STAGE "$ROOT/anvil/80_slab_relax_seeded.slurm"
