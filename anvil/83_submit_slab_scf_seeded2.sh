#!/bin/bash
# Submit Seeded SCFs on two more retained densities, 2026-09-22 held; caller verifies scheduler fields before release. No retry/override.
set -euo pipefail
export PROJECT=/anvil/projects/x-che260157
export STAGE=slab_scf_seeded2
ROOT="$PROJECT/sts"
SPEC="$ROOT/results/lowtail_low_state_restart_2026-09-22/scf/launch_spec.json"
...
sbatch --parsable --hold --no-requeue -A che260157 -p shared -N 1 -n 128 \
    ...
    --export=ALL,PROJECT,STAGE "$ROOT/anvil/82_slab_scf_seeded2.slurm"
