# STS 2027 — TODO (ARCHIVED 2026-07-01, pre-thermal-pivot)

> Frozen copy of `tasks/todo.md` as it stood before the 2026-07-01 thermal pivot
> ([docs/24](../docs/24-thermal-pivot-execution-plan.md)). Kept as an explicit
> backup of the pre-pivot decision state; the catalysis plan itself lives on in
> docs/12–23 + `tasks/plan-catalysis-hea.md` / `tasks/plan-her-discovery.md`
> (all untouched by the pivot).
