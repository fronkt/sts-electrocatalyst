...
- **B3. JACS 2024,** "Designing 3d Transition Metal Cation-Doped MRuOₓ as Durable Acidic OER Electrocatalysts for PEM," **DOI 10.1021/jacs.4c04096** [PAYWALLED/SEARCH]; and **B3b. JACS 2025,** "Dual-Descriptor-Guided Screening of Stable Metal-Doped RuO₂ Catalysts for Acidic OER," **DOI 10.1021/jacs.5c17145** [PAYWALLED/SEARCH]. Together these show **stability-and-activity dual-descriptor screening of metal-doped RuO₂ is already state-of-the-art as of 2025.**
- **B4. Rational design of β-MnO₂ via Ir/Ru co-substitution (2024),** *ACS Catalysis*, **DOI 10.1021/acscatal.4c05989** [PAYWALLED/SEARCH]. DFT+exp; substitution drives AEM→OPM (oxide-path). Shows the *reverse* direction (noble metal into 3d rutile) is also being worked.
- **B5. (M,Ru)O₂ (M = Mg, Zn, Cu, Ni, Co) rutiles as acidic OER catalysts in MEAs,** *Chemistry of Materials* 2020, **DOI 10.1021/acs.chemmater.0c01884** [PAYWALLED/SEARCH]. Earth-abundant divalent metals into rutile RuO₂ to cut Ru loading — the mixed-rutile compositional space is being explored experimentally.
...
- **B7. DigCat closed loop (2025),** "Closed-Loop Framework for Discovering Stable and Low-Cost Bifunctional Metal Oxide Catalysts…in Acid," *JACS*, **DOI 10.1021/jacs.5c04079** [PAYWALLED/SEARCH]. Data-mining + microkinetics + experiment.
