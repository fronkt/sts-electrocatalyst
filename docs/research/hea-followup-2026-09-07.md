...
## Status and first matched spin-control pairs — 2026-09-08 11:49 UTC

The 11:48:50 UTC snapshot shows six accepted SCF/projection endpoints (tasks 1, 3, 4, 6, 7, 8), two SCF time-limit failures (2, 5), one running task (9, ortho/fragment builder, on a206) and five pending under JobArrayTaskLimit. All eight terminal Slurm statuses are FAILED: six are the already diagnosed retention-only exit 14, two are nonconverged exit 10. The five newly accepted densities are now recovered without DFT retries: each full set of non-wavefunction files matches preserved scratch, XML parses, and the nonempty density has the HDF5 signature. All scratch and wavefunctions remain preserved. The array's copied runner is unchanged.

Two additional matched atomic-projector pairs are available. E(pull2.10)-E(builder) is -2.439226 eV for metal_alternating and -2.050039 eV for fragment, versus -2.053398 eV in the pilot; shifts are -0.385828 and +0.003359 eV, respectively. All three sampled pairs favor the pulled fixed endpoint. The metal-alternating solutions are higher than their corresponding pilot endpoint energies by +2.63248 eV (builder) and +2.24665 eV (pull), so their different gap does not replace the pilot with lower-energy endpoints.

Near agreement in the fragment-start pair's energy gap does not imply identical electronic states. The builder's projected HO2 moment reverses from +1.0430 to -1.0422 muB, while total magnetization changes from 38.09 to 36.00 muB. The newly converged ortho metal-alternating pull has O2 projected moment -0.1632 muB, versus -2.0204 muB in its atomic counterpart. These results expose spin/projector dependence; no magnetic ground state is established.
