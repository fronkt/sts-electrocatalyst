...
**B6. Tripković, Hansen, García-Lastra, et al. (2018). "Comparative DFT+U and HSE Study of the Oxygen Evolution Electrocatalysis on Perovskite Oxides."** *J. Phys. Chem. C* 122(2), 1135–1147. DOI: **10.1021/acs.jpcc.7b07660**. **[HELD LOCALLY: `papers/Tripkovic-2018_JPCC_DFTU-vs-HSE-perovskite-OER.pdf`]**; [DTU Orbit](https://orbit.dtu.dk/en/publications/comparative-dftu-and-hse-study-of-the-oxygen-evolution-electrocat/).
...
**B9. (bulk→surface shortcut) "Prediction of O and OH Adsorption on Transition Metal Oxide Surfaces from Bulk Descriptors."** *ACS Catal.* 2024, 14. DOI: **10.1021/acscatal.4c00111**. **[HELD LOCALLY: `papers/Comer-2024_ACSCatal_O-OH-adsorption-from-bulk-descriptors.pdf`]**; [ACS landing](https://pubs.acs.org/doi/10.1021/acscatal.4c00111).
...
**Grimaud, Diaz-Morales, Han, et al. (2017). "Activating lattice oxygen redox reactions in metal oxides to catalyse oxygen evolution."** *Nat. Chem.* 9(5), 457–465. DOI: **10.1038/nchem.2695**. **[HELD LOCALLY: `papers/Grimaud-2017_NatChem_lattice-oxygen-redox.pdf`]**; abstract + summary via [Experts@Minnesota](https://experts.umn.edu/en/publications/activating-lattice-oxygen-redox-reactions-in-metal-oxides-to-cata/).
...
- **Exner (2020). "A Universal Descriptor for the Screening of Electrode Materials for Multiple-Electron Processes: Beyond the Thermodynamic Overpotential."** *ACS Catal.* 10, 12607–12617. DOI: **10.1021/acscatal.0c03865**. **[HELD LOCALLY]** — `papers/Exner-2020_ACSCatal_universal-descriptor-beyond-eta.pdf`. *Corrected 2026-08-11: this entry previously read "2021, 11(6), 3234–3241"; the PDF's own front matter for this DOI is 2020, 10, 12607–12617.*
- **Razzaq & Exner (2023). "Materials Screening by the Descriptor Gmax(η): The Free-Energy Span Model in Electrocatalysis."** *ACS Catal.* 13, 1740–1758. DOI: **10.1021/acscatal.2c03997**. **[HELD LOCALLY]** — `papers/Razzaq-Exner-2023_ACSCatal_Gmax-free-energy-span.pdf`; [PubMed 36776387](https://pubmed.ncbi.nlm.nih.gov/36776387/).
...
- **"Solvation Effects for Oxygen Evolution Reaction Catalysis on IrO₂(110)."** *J. Phys. Chem. C* 2017, 121. DOI: **10.1021/acs.jpcc.7b02383**. **[HELD LOCALLY: `papers/Gauthier-2017_JPCC_solvation-IrO2-110.pdf`]**.
- **Inico, et al. (2024). "Stability and Solvation of Key Intermediates of Oxygen Evolution on TiO₂, RuO₂, IrO₂ (110) Surfaces: A Comparative DFT Study."** *ChemCatChem* 16. DOI: **10.1002/cctc.202400813**. **[HELD LOCALLY: `papers/Inico-2024_ChemCatChem_stability-solvation-TiO2-RuO2-IrO2-110.pdf`]**; [ResearchGate](https://www.researchgate.net/publication/382409953). Compares single-water, bilayer, and AIMD interface solvation — quantifies how explicit water stabilizes H-bond-donating OH*/OOH* and even a non-standard –OO(H) intermediate.
- Most recent (2026): **Qiu, et al. (2026). "Potential-Dependent Oxygenated Surface Phases and Interfacial Water Layers Underlie the High Overpotential and Mechanistic Switching of Oxygen Evolution on RuO₂."** *Angew. Chem. Int. Ed.* DOI: **10.1002/anie.202521856**. **[HELD LOCALLY: `papers/Qiu-2026_AngewChem_potential-dependent-phases-RuO2.pdf`]** — combines potential-dependent terminations (C1) + interfacial water (C5) for rutile RuO₂; the current state of the art for this exact system.

---

## D. ACCURACY REALITY CHECK

**D1. Fabbri, Schmidt (2018). "Oxygen Evolution Reaction—The Enigma in Water Electrolysis."** *ACS Catal.* 8(10), 9765–9774. DOI: **10.1021/acscatal.8b02712**. [ACS landing](https://pubs.acs.org/doi/10.1021/acscatal.8b02712) (**[HELD LOCALLY: `papers/Fabbri-2018_ACSCatal_OER-enigma-viewpoint.pdf`]** full text).
