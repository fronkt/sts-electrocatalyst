...
| `t.py`, `t2.py` | 1,285 / 2,274 | see SHA256SUMS | the pymatgen `AdsorbateSiteFinder` census scripts run OUTSIDE the repo on a hand-built RuO₂(110) slab (the non-blind rutile arm of P-BUILDER); `t2.py` is the one whose exact arguments A9.3.5 registers | AI-written, 2026-08-15 |
